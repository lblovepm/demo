...
public class CronTest {
     ...
     */
    private static void descSecond(String tmpCorns, StringBuffer sBuffer) {
        String danwei="秒";
        desc(tmpCorns, sBuffer, danwei);
    }
     ...
     */
    private static void descMintue(String tmpCorns, StringBuffer sBuffer) {
        desc(tmpCorns, sBuffer, "分钟");
    }
     ...
     */
    private static void descHour(String tmpCorns, StringBuffer sBuffer) {
        desc(tmpCorns, sBuffer, "小时");
    }
     ...
     */
    private static void descDay(String tmpCorns, StringBuffer sBuffer) {
        desc(tmpCorns, sBuffer, "天");
    }
     ...
     */
    private static void descWeek(String tmpCorns, StringBuffer sBuffer) {
        //不解释 太麻烦
    }
...
//    }
     ...
     */
    private static void descMonth(String tmpCorns, StringBuffer sBuffer) {
        desc(tmpCorns, sBuffer, "月");
    }
